...
# create boxplot
a = sns.boxplot(x="Year", y="Weight", ax=ax, hue="Sex", 
palette={"Male": "#18a1cd", "Female":"#fa8c00"}, 
data=summer_df)
        
ax.set_xlabel('Year', size=14, labelpad=10)
ax.set_ylabel('Weight (kg)', size=14, labelpad=10)
ax.set_title('Weight distribution of Hungarian atheletes in Summer Olympic games 1960-2016', size=16, pad=20, weight='heavy')
plt.show()